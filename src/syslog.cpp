...
/*
* @brief    输出日志信息。
* @param    [in] const char* file_name		文件名\n
* @param    [in] const int line				行号\n
* @param    [in] severity_levels level		日志级别\n
* @param    [in] const char* fmt			格式化参数\n
* @return   无\n
* @note
* @warning
* @bug
...
/*
* @brief    构造文件+函数信息,例如:[main.cpp:14]。
* @param    [in] const char* file_name		文件名\n
* @param    [in] const int line				行号\n
* @return   无\n
* @note
